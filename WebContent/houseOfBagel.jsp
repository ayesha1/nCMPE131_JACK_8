...
<body>
    ...
    <div class="container">
      ...
      <br>
        <div class="row">
            <div class="col-sm-3">
                <h1>House Of Bagel</h1>
                <button type="button" class="btn btn-secondary"><a  href="houseOfbagelsComment.html">Write Review</a></button>
    ...
    %>
    	...
    	<%
    		try {
    			...
    			String sql = "SELECT * FROM houseOfBagels";
